...
const MyWishlistItem = ({key}) => {
    ...
    const wishlistItemCrossBtn = document.querySelector('.wishlist-item-cross-btn');
    

    // if(wishlistItemCrossBtn){

    //     if(isHoverBtn === true){
    //         wishlistItemCrossBtn.classList.add('wishlist-item-cross-btn1-display');
            
    //     }else if(isHoverBtn === false){
            
    //         wishlistItemCrossBtn.classList.remove('wishlist-item-cross-btn1-display')
        ...
        <>
            <li className='wishlist-list-item-container'>
                <form className='wishlist-list-item-container-form'>
                    ...
                    <div onMouseEnter={()=>setIsHoverBtn(true)} onMouseLeave={()=>setIsHoverBtn(false)} className='wishlist-list-item-container-form-div wishlist-list-item-container-form-div-margin'>
                        ...
                        <button className={`wishlist-item-cross-btn wishlist-item-cross-btn1 wishlist-item-cross-btn2 ${isHoverBtn ? 'wishlist-item-cross-btn1-display': '' }`}>X</button>
                    </div>
                </form>
            </li>
        </>
